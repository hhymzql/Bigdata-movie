<%@ page import="oracle.demo.oow.bd.hbase.dao.MovieDAO" %>
<%@ page import="oracle.demo.oow.bd.hbase.dao.CustomerDAO" %>
...
<%@ page import="oracle.demo.oow.bd.hbase.dao.CustomerRatingDAO" %>
    ...
    if (movieId != null){
		CustomerDAO cdao = new CustomerDAO();
  		...
  		if (activityTO != null && activityTO.getRating()!=null){
  			System.out.print("movieInfo:activityTO="+activityTO);
  		}
	  ...
	  MovieTO movieTO = movieDAO.getMovieById(Integer.parseInt(movieId));
	  ...
	  System.out.println("movieInfo:genres="+genres); 
