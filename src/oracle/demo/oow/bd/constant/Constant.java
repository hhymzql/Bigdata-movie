...
public interface Constant {
    ...
    public static final String TMDb_IMG_URL = "http://image.tmdb.org/t/p/w92/";
    //This is Anuj's key. Other users should get their own keys
    public static final String TMDb_KEY = "?api_key=1af3d470678b6107247ce98ec7cef097";
    public static final String TMDb_MOVIE_INFO_URL = "http://api.themoviedb.org/3/movie/";
    public static final String TMDb_MOVIE_CAST = "/casts";

    public static final int MAGIC_NUM = 191;

    /** TMDb Movie File names **/
    public static final String MOVIE_INFO_FILE_NAME = METADATA_DIR + File.separator + "movie-info.out";
    public static final String MOVIE_CASTS_FILE_NAME = METADATA_DIR + File.separator + "movie-cast.out";
    public static final String MOVIE_IMG_FILE_NAME = METADATA_DIR + File.separator + "movie-img.out";
    public static final String MOVIE_CREW_FILE_NAME = METADATA_DIR + File.separator + "movie-crew.out";

    /** Analytics File **/
    public static final String USER_ITEM_FILE_NAME = METADATA_DIR + File.separator + "user-item.out";

    /** Customer Profiles **/
    public static final String CUSTOMER_PROFILE_FILE_NAME = METADATA_DIR + File.separator + "customer.out";


    public static final String WIKI = "wikipedia";

    public static final String NO_PROFILE_IMG =
        "http://cf2.themoviedb.org/assets/8ede7fdf39f4c/images/no-profile-w185.jpg";

    //wikipedia files
    public static final String WIKI_MOVIE_INFO_FILE_NAME =
        METADATA_DIR + File.separator + WIKI  + File.separator + "movie-info.out";

    public static final String WIKI_MOVIE_CAST_FILE_NAME =
        METADATA_DIR + File.separator + WIKI + File.separator + "movie-cast.out";

    public static final String WIKI_MOVIE_CREW_FILE_NAME =
        METADATA_DIR + File.separator + WIKI + File.separator + "movie-crew.out";
