...
public class ConstantsHBase {
	...
	public static String ZOOKEEPER = "node";
	public static String HBASE_ROOT_DIR = "hdfs://node:9000/hbase";
	public static String MYSQL_USERNAME = "root";
	public static String MYSQL_PASSWORD = "root";
	public static String MYSQL_DRIVER = "com.mysql.jdbc.Driver";
	public static String MYSQL_URL = "jdbc:sqlserver://localhost:3306/movie?useUnicode=true&characterEncoding=utf-8";
